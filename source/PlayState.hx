...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'renoback': //Week R
				var bg:BGSprite = new BGSprite('background', -500, -300, 0.9, 0.9);
				add(bg);

			case 'eddhouse': //Week T
				var ebg:BGSprite = new BGSprite('sky', -300, -300, ['bg_sky1']);
				add(ebg);
				
				var fg:BGSprite = new BGSprite('bgFront', -300, -300, ['bg_normal']);
				add(fg);
